...
activities = {
    ...
    "Swimming Club": {
        "description": "Improve swimming techniques and train for local competitions",
    ...
    "Music Ensemble": {
        "description": "Practice instrumentals and performances for school events",
    ...
    "Science Club": {
        ...
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["marco@mergington.edu", "zoe@mergington.edu"]
    }
}
